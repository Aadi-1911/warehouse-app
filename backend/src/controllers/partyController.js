...
// real, current (2026) list of 28 states + 8 union territories (rule 105) — fixed and closed,
...
//
// `state` is required HERE ONLY (rule 105, added 2026-09-09) — enforced at this application
