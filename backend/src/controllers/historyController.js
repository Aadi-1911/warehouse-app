...
async function listHistory(req, res) {
  ...
  //
  // This is one of the few entry types in this feed that states a real rupee amount. That is
  // deliberate and is not the costPrice leak this file's header warns about: this is a
  // SELLING-side figure — what a party owes — of exactly the kind Party Payables already shows,
  // and the entry is meaningless without it: "amount owed to the business" is the entire content
  // of the event.
