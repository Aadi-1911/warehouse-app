...
// The real, current (2026) list of 28 states + 8 union territories (rule 105) — a fixed, closed
...
export default function Parties() {
  ...
  // Required (rule 105) — validated in handleCreate below, the same manual pre-submit check
  ...
  async function handleCreate(event) {
    ...
    setCreateError(null);
    // Manual required-check (rule 105) — Combobox has no native `required` attribute to lean on,
                    ...
                    <div className="accordion-body nested">
                      ...
                      {p.state && (
                        <div className="party-detail-row">
                          ...
                          {/* Existing parties from before rule 105 have state: null — this row
