...
export default function Parties() {
  ...
  // --- Billing correction (rule 108) — DELIBERATELY SEPARATE STATE from the bill-no edit above,
              ...
              {ordersError ? (
                ...
                orders.map((o) => (
                  <div key={o.id} className={`dash-party-order-row${o.isCancelled ? ' dash-party-order-row-cancelled' : ''}`}>
                    ...
                    {/* Discount/GST correction (rule 108) — same row as Bill No. above, as asked,
